...
libraryDependencies ++= Seq(
  ...
  "org.apache.spark" % "spark-mllib_2.10" % "1.2.0-cdh5.3.0" % "provided",
  ...
  "org.apache.hbase" % "hbase-hadoop-compat" % "0.98.6-cdh5.3.0" % "provided",
  "org.apache.hbase" % "hbase-it" % "0.98.6-cdh5.3.0" % "provided",
  "org.apache.hbase" % "hbase-hadoop2-compat" % "0.98.6-cdh5.3.0" % "provided",
  "org.apache.hbase" % "hbase-prefix-tree" % "0.98.6-cdh5.3.0" % "provided",
  "org.apache.hbase" % "hbase-protocol" % "0.98.6-cdh5.3.0" % "provided",
  "org.apache.hbase" % "hbase-server" % "0.98.6-cdh5.3.0" % "provided",
  "org.apache.hbase" % "hbase-shell" % "0.98.6-cdh5.3.0" % "provided",
  "org.apache.hbase" % "hbase-testing-util" % "0.98.6-cdh5.3.0" % "provided",
  "org.apache.hbase" % "hbase-thrift" % "0.98.6-cdh5.3.0" % "provided",
